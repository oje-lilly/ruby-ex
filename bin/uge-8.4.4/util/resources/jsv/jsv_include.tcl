...
set jsv_cli_params [list a ar A b ckpt cwd C display dl e hard h hold_jid \
                         hold_jid_ad i inherit j jc js m M masterq mbind notify \
                         now N noshell nostdin o ot P p pty R r shell sync S t \
                         tc tcon terse u w wd]

set jsv_mod_params [list ac l_hard l_soft masterl q_hard q_soft pe_min pe_max pe_name \
...
proc jsv_set_timeout {new_timeout} {
   jsv_send_command "SEND TIMEOUT $new_timeout"
}
