...
#
#     It is also possible to change the default timeout of a client or 
#     sever JSV. The buildin timeout is 10 seconds. In client JSV's this 
#     default can be overwritten by defining an environment variable named
#     SGE_JSV_TIMEOUT in server JSV's this is done by defining a 
#     qmaster_param named 'jsv_timout'. Using the function jsv_set_timeout()
#     will overwrite SGE_JSV_TIMEOUT and 'jsv_timout'
#
#  INPUTS
#     None
#
