...
@EXPORT_OK = qw(
   ...
   jsv_send_command jsv_send_error jsv_send_env jsv_set_timeout
   jsv_script_log 
...

{
   my %is_list_command = ();
   @is_list_command{
      qw(ac e hold_jid hold_jid_ad i l_hard l_soft masterl M m masterq o pe q q_hard q_soft S u)
   } = ();
...
sub jsv_set_timeout {
   jsv_send_command("SEND TIMEOUT @_");
}
