 ...
 *   All Rights Reserved.
 *
 *  Portions of this software are Copyright (c) 2013 Univa Corporation
 *
 ************************************************************************/
/*___INFO__MARK_END__*/
...
BEGIN
{
   printf("%20s |%7s %7s |%4s %4s %4s|%7s %7s %7s|%7s %7s %7s %7s|%7s %7s %7s %7s",
...
/$5 == 0/
{
   printf("%20Y | %7d %7d|%4d %4d %4d|%7d %7d %7d|%7d %7d %7d %7d|%7d %7d %7d %7d",
        walltimestamp, wrt, wrt_total/1000000, rep, gdi, ack, dsp, dsp_total, sad,
        add_in, remove_in, add_out, remove_out, lck0, ulck0, lck1, ulck1);
   rep = 0;
   ack = 0;
   gdi = 0;
   wrt = 0;
