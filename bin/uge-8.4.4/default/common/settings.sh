SGE_ROOT=/opt/uge/uge-8.4.4; export SGE_ROOT

USE_SYSTEMD=true; export USE_SYSTEMD
ARCH=`$SGE_ROOT/util/arch`
DEFAULTMANPATH=`$SGE_ROOT/util/arch -m`
MANTYPE=`$SGE_ROOT/util/arch -mt`

SGE_CELL=default; export SGE_CELL
SGE_CLUSTER_NAME=p6434; export SGE_CLUSTER_NAME
SGE_QMASTER_PORT=6434; export SGE_QMASTER_PORT
SGE_EXECD_PORT=6435; export SGE_EXECD_PORT
