...
/* 
 * extension for drmaa_sudo requests 
 */
typedef struct drmaa_sudo_s drmaa_sudo_t;
 ...
 * the nth value, i.e. value[n], being set to NULL as a delimiter.
 *
...
int drmaa_run_job_as(drmaa_sudo_t *delegate, char *job_id, size_t job_id_len,
                  const drmaa_job_template_t *jt, char *error_diagnosis,
                  size_t error_diag_len);
...
int drmaa_run_bulk_jobs_as(drmaa_sudo_t *delegate, drmaa_job_ids_t **jobids,
                        const drmaa_job_template_t *jt, int start, int end,
                        int incr, char *error_diagnosis, size_t error_diag_len);
...
int drmaa_control_as(drmaa_sudo_t *delegate, const char *jobid, int action, char *error_diagnosis,
                  size_t error_diag_len);
 ...
 * with the nth value, i.e. job_ids[n], being set to NULL as a delimiter.
 *
