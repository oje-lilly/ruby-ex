 ...
 *
 * Changes to 8.2.3:
 * - OGF issue 287: PPC64LE was added
 * - OGF issue 102: Adding jobName to jinfo struct (incompatible)
 * - OGF issue 165: Allocated machines is a machine info list.
 * - OGF issue 116: Adding a set of default callbacks.
 * - OGF issue 160 / 162: Adding implementation specific void * pointers.
 **/
#ifndef DRMAA2_H
#define DRMAA2_H
...
#define DRMAA2_UNSET_PRIORITY -99999
...
/* 
 * extension for drmaa2_sudo requests 
 */
typedef struct drmaa2_sudo_s drmaa2_sudo_t;
...
drmaa2_r drmaa2_rsession_request_reservation_as(drmaa2_sudo_t *auth, const drmaa2_rsession rs, const drmaa2_rtemplate rt);
...
drmaa2_error drmaa2_r_terminate_as(drmaa2_sudo_t *auth, drmaa2_r reservation);
...
drmaa2_error drmaa2_jarray_suspend_as(drmaa2_sudo_t *auth, drmaa2_jarray jarray);
drmaa2_error drmaa2_jarray_resume(drmaa2_jarray jarray);
drmaa2_error drmaa2_jarray_resume_as(drmaa2_sudo_t *auth, drmaa2_jarray jarray);
drmaa2_error drmaa2_jarray_hold(drmaa2_jarray jarray);
drmaa2_error drmaa2_jarray_hold_as(drmaa2_sudo_t *auth, drmaa2_jarray jarray);
drmaa2_error drmaa2_jarray_release(drmaa2_jarray jarray);
drmaa2_error drmaa2_jarray_release_as(drmaa2_sudo_t *auth, drmaa2_jarray jarray);
drmaa2_error drmaa2_jarray_terminate(drmaa2_jarray jarray);
drmaa2_error drmaa2_jarray_terminate_as(drmaa2_sudo_t *auth, drmaa2_jarray jarray);
drmaa2_error drmaa2_jarray_reap(drmaa2_jarray jarray);
...
drmaa2_jarray drmaa2_jsession_get_job_array(const drmaa2_jsession jsession, const drmaa2_string jobarrayid);
drmaa2_j drmaa2_jsession_run_job_as(drmaa2_sudo_t *auth, const drmaa2_jsession jsession, const drmaa2_jtemplate jtemplate);
drmaa2_j drmaa2_jsession_run_job(const drmaa2_jsession jsession, const drmaa2_jtemplate jtemplate);
drmaa2_jarray drmaa2_jsession_run_bulk_jobs_as(drmaa2_sudo_t *auth,
                                               const drmaa2_jsession jsession,
...
drmaa2_j drmaa2_jsession_wait_any_terminated(const drmaa2_jsession jsession,
                                             const drmaa2_j_list joblist,
                                             const time_t timeout);
drmaa2_j_list drmaa2_jsession_wait_all_started(const drmaa2_jsession jsession,
                                               const drmaa2_j_list joblist,
                                               const time_t timeout);
drmaa2_j_list drmaa2_jsession_wait_all_terminated(const drmaa2_jsession jsession,
                                                  const drmaa2_j_list joblist,
                                                  const time_t timeout);

drmaa2_error drmaa2_j_suspend(drmaa2_j job);
drmaa2_error drmaa2_j_suspend_as(drmaa2_sudo_t *auth, drmaa2_j job);
drmaa2_error drmaa2_j_resume(drmaa2_j job);
drmaa2_error drmaa2_j_resume_as(drmaa2_sudo_t *auth, drmaa2_j job);
drmaa2_error drmaa2_j_hold(drmaa2_j job);
drmaa2_error drmaa2_j_hold_as(drmaa2_sudo_t *auth, drmaa2_j job);
drmaa2_error drmaa2_j_release(drmaa2_j job);
drmaa2_error drmaa2_j_release_as(drmaa2_sudo_t *auth, drmaa2_j job);
drmaa2_error drmaa2_j_terminate(drmaa2_j job);
drmaa2_error drmaa2_j_terminate_as(drmaa2_sudo_t *auth, drmaa2_j job);
...
drmaa2_string drmaa2_msession_get_session_name(const drmaa2_msession monitoring_session);
drmaa2_r_list drmaa2_msession_get_all_reservations(const drmaa2_msession monitoring_session, const drmaa2_rinfo filter);
...
drmaa2_jsession drmaa2_create_jsession_as(drmaa2_sudo_t *auth, const char * session_name, const char * contact);
drmaa2_jsession drmaa2_create_jsession(const char * session_name, const char * contact);
drmaa2_rsession drmaa2_create_rsession_as(drmaa2_sudo_t *auth, const char * session_name, const char * contact);
...
drmaa2_error drmaa2_destroy_jsession_as(drmaa2_sudo_t *auth, const char * session_name);
drmaa2_error drmaa2_destroy_rsession(const char * session_name);
drmaa2_error drmaa2_destroy_rsession_as(drmaa2_sudo_t *auth, const char * session_name);
...
{
   drmaa2_string id;                   /* The GE reservation id */
   drmaa2_string session_name;         /* The DRMAA2 session the reservation is running in. */
} drmaa2_r_s;
...
/* add mem usage values to jinfo */
#define JI_MEM_VALUES
